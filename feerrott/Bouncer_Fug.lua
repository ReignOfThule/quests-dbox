...
function set_base_stats(e)
	...
	if (level == "20") then
        ...
        --e.self:ModifyNPCStat("special_abilities", "1,1,10000,97^14,1^16,1^17,1^31,1^33,1,100");
        --e.self:ModifyNPCStat("special_abilities", "1,1,10000,97^14,1^16,1^17,1^31,1^33,1,100^19,1^20,1");
